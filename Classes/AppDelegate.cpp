...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if (frameSize.height == iphone4.size.height && frameSize.width == iphone4.size.width) {
        director->setContentScaleFactor(MIN(iphone4.size.height/designResolutionSize.height,
                                            iphone4.size.width/designResolutionSize.width));
        ...
        director->setContentScaleFactor(MIN(iphone6.size.height/designResolutionSize.height,
                                            iphone6.size.width/designResolutionSize.width));

    }else if (frameSize.height == iphone6_plus.size.height && frameSize.width == iphone6_plus.size.width){
        director->setContentScaleFactor(MIN(iphone6_plus.size.height/designResolutionSize.height,
                                            iphone6_plus.size.width/designResolutionSize.width));
